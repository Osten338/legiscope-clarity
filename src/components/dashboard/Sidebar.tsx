...
export const Sidebar = () => {
  ...
  return (
    <SidebarPrimitive className="h-full">
      <SidebarContent className="fixed top-0 left-0 z-40 h-screen border-r border-slate-200 bg-white shadow-sm transition-all duration-300 flex flex-col min-w-[68px] data-[collapsed=true]:w-[68px] data-[collapsed=false]:w-64">
