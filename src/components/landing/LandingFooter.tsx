...
export const LandingFooter = () => {
  return (
    <footer className="bg-black text-white py-16 px-4 md:px-8 lg:px-20">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-8 mb-12">
          <div className="mb-8 md:mb-0 max-w-sm">
            ...
            <p className="text-white/70 mb-6">
              Simplifying regulatory compliance for businesses of all sizes with powerful, intuitive software.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              <h4 className="font-medium mb-4 text-brand-blue">Product</h4>
              <ul className="space-y-3">
                <li><a href="#features" className="text-white/70 hover:text-white text-sm">Features</a></li>
                <li><a href="#pricing" className="text-white/70 hover:text-white text-sm">Pricing</a></li>
                <li><a href="#" className="text-white/70 hover:text-white text-sm">Case Studies</a></li>
                <li><a href="#" className="text-white/70 hover:text-white text-sm">Documentation</a></li>
              </ul>
            </div>
            
            <div>
              <h4 className="font-medium mb-4 text-brand-blue">Company</h4>
              <ul className="space-y-3">
                <li><a href="#" className="text-white/70 hover:text-white text-sm">About Us</a></li>
                <li><a href="#" className="text-white/70 hover:text-white text-sm">Careers</a></li>
            ...
            <div>
              <h4 className="font-medium mb-4 text-brand-blue">Legal</h4>
              <ul className="space-y-3">
        ...
        {/* Add trust logos section */}
        <div className="py-8 border-t border-white/10 mb-8">
          <h5 className="text-sm text-white/50 mb-5 text-center">Trusted by compliance teams globally</h5>
        ...
        <div className="border-t border-white/10 pt-8 text-white/50 text-sm">
