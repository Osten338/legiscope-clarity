...
export const LandingHero = () => {
  return (
    <section className="relative w-full pt-32 pb-20 px-4 md:px-8 lg:px-0 flex items-center min-h-[85vh] bg-black/[0.96] antialiased bg-grid-white/[0.02] overflow-hidden">
      <Spotlight
