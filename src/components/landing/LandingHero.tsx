...
export const LandingHero = () => {
  return (
    <section className="relative w-full pt-24 pb-16 px-4 md:px-8 lg:px-0 flex items-center min-h-[70vh] bg-gradient-to-br from-[#0f1f47cc] to-[#152f6bcc]"> {/* dark blue translucent background */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-14 z-10 relative">
        <div className="lg:w-1/2 text-white">
          <span className="inline-block mb-6 px-4 py-1.5 rounded-full bg-black/40 text-white font-medium shadow">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="rounded-full text-base bg-black/40 border-gray-300 border shadow text-white hover:bg-black/60">
        ...
        <div className="lg:w-1/2 flex justify-center">
          ...
          <div className="relative bg-gradient-to-br from-black/30 to-black/10 border border-gray-700 shadow-xl rounded-3xl px-8 py-10 w-full max-w-md">
